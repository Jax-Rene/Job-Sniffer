...
public enum JobType {
    HOU_DUAN(1, "后端开发", "Java,Python,PHP,.NET,C#,C++,C,VB,Delphi,Perl,Ruby,Hadoop,Node.js,数据挖掘,自然语言处理,搜索算法,精准推荐,全栈工程师,Go,ASP,Shell,后端开发其他",
            "Java,Python,PHP,.NET,C#,C++,C,VB,Delphi,Perl,Ruby,Hadoop,Node.js,数据挖掘,自然语言处理,搜索算法,推荐,全栈工程师,Go,ASP,Shell,后端"),
    ...
    XIANG_MU(7, "项目", "项目经理,项目助理", "项目经理,项目助理,项目"),
    ...
    QI_YE(9, "实施", "实施工程师,售前工程师,售后工程师,BI工程师,企业软件其它", "实施工程师,售前工程师,售后工程师,BI,QA,企业"),
    QI_TA(10,"其他","其他","其他");
    private int index;
