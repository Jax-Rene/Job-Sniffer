...
public enum JobType {
    ...
    YI_DONG(2, "移动开发", "Android,IOS,WP,移动开发其他", "Android,IOS,WP,移动开发其他"),
    QIAN_DUAN(3, "前端开发", "web前端,Flash,html5,JavaScript,U3D,COCOS2D-X,前端开发其他", "web前端,Flash,html5,JavaScript,U3D,COCOS2D-X,前端开发"),
    ...
    DBA(6, "DBA", "MySQL,SQLServer,Oracle,DB2,MongoDB,ETL,Hive,数据仓库,DBA其它", "MySQL,SQLServer,Oracle,DB2,MongoDB,ETL,Hive,数据仓库,DBA其它"),
    XIANG_MU(7, "项目", "项目经理,项目助理", "项目经理,项目助理"),
    ...
    QI_YE(9, "实施", "实施工程师,售前工程师,售后工程师,BI工程师,企业软件其它", "实施工程师,售前工程师,售后工程师,BI,企业软件其它");
